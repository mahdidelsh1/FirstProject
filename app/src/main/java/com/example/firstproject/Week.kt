...
data class Week (var WeekNumber : Int , var date : Date = Date()) {

    lateinit var realDate : String
    ...
    init {
        ...
        realDate =    shamsi[0].toString()+"/"+shamsi[1].toString()+"/"+shamsi[2].toString()

    }


   private fun gregorian_to_jalali(gy: Int, gm: Int, gd: Int): IntArray {
